...
import io.versailles.application.command.{AcknowledgeClientStateChange, ApplyEncryptionToFolder, RequestAssetFolder}
import io.versailles.application.event.AssetFolderEjected
import io.versailles.application.model.{Archive, Folder, FolderRequest}
